...
function SearchBooks({ hits, searchValue }, props) {
    console.log(props.url);
    searchingValue = searchValue
    console.log(searchingValue, "15145554545");
    ...
    const routing = {
        router: history({
            createURL({ qsModule, routeState, location }) {
                ...
                //   : '';
                const newQueryParam = location.href.split("?")[1]
                console.log(newQueryParam, "2156154658465545");
                console.log(props.searchValue, "2156154658465545");

                const queryParameters = {};
                if (!newQueryParam) {
                    return `/search?${newQueryParam}`;
                }
            ...
            stateToRoute(uiState) {
                ...
                if ("refinementList" in indexUiState) {
                    ...
                    return {
                        ...
                        sortBy: `${INSTANTSEARCHSCHEMA}/sort/num_is_out_of_stack:asc,uDate:desc`,
                    };
                }
            },
                ...
                >
                    ...
                    >
                        ...
                        <div style={{ margin: "0.5rem 0rem 0.5rem 1rem" }}>
                            ...
                            <CustomRefinementList searchable={true} attribute="author" label="Author" />
                        </div>
                        ...
                        <div style={{ margin: "1rem 0rem 0.5rem 1rem" }}>
                            ...
                            <CustomRefinementList
                                attribute="agedGroup" label="Age Group"
                            />
                        </div>
                        <div style={{ margin: "1rem 0rem 0.5rem 1rem" }}>
