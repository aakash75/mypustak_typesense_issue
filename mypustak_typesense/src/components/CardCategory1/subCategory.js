...
import NcertUpDiv from "../ncert/ncertUpperDiv";
...
import CustomCategoryHits from "../instantsearchcustomcomponents/CustomCategoryHits";
...
const NextBreadcrumbs = dynamic(
    () => import("../Breadcrumbs/NextBreadcrumbs"),
    { ssr: false }
);
...
//   let firstcat_url = `/category/` + query.parent_category + `/`;
...
//   }
//   else{
//     title_tag = "Best "+query.parent_category+"|"+query.sub_category +'|used books online India !'
//     meta_description = "Best "+ query.parent_category +"|"+query.sub_category +'Only online free books used bookstore'
//   }
//   console.log(title_tag ,"||", meta_description)

//   return { props: { query, CATID, category_url: category_url, FIRSTCAT ,title_tag,meta_description,
//     og_url:og_url} };
// }
...
const typesenseInstantsearchAdapter = new TypesenseInstantsearchAdapter({
    ...
    additionalSearchParameters: {
        ...
        facet_by:
            "author,publication,parentCategory,category,language,keywords,bookType,binding,bookCondition,subject,class",
        max_facet_values: 30,
        num_typos: 2,
...
function Page(props) {
    ...
    return (
        <React.Fragment>
            ...
            <NextBreadcrumbs />
            <div>
                {/* {props.CATID.id == 280 ? <NcertUpDiv /> : null} */}
                <InstantSearch
                    ...
                    <Configure
                        filters={
                            props.CATID.id == 352 ||
                                ...
                                : `parentCategory:${props.CATID}`
                        }
                    // filters={`category:${props.CATID}`}
                    />
                ...
                <span
                  ...
                  {GetCategoryName(props.FIRSTCAT.id).name}
                </span>
                {props.CATID.id == 352 ||
                props.CATID.id == 350 ||
                props.CATID.id == 361 ||
