...
// import stylesCat from "../../styles/CategoryNavbar.module.css";
// import cod_img from '../../assets/cod.svg'
// import netBanking_img from '../../assets/netBanking_img.svg'
// import mastercard_img from '../../assets/mastercard_img.svg'
// import visa_card_img from '../../assets/visa_card_img.svg'
// import maestro_img from '../../assets/maestro_img.svg'
// import upi_img from '../../assets/upi_img.svg'
// import phonepe_img from '../../assets/phonepe_img.svg'
// import paytm_img from '../../assets/paytm_img.svg'
// import rupay_img from '../../assets/rupay_img.svg'
    ...
    return (
      <footer className="mainfooter d-none d-md-block d-sm-block d-lg-block">
        ...
        <div className="footermain_div">
          <div className="row" style={{display:"flex", flexDirection:"row"}}>
              ...
              <div className="heading_div">
                ...
                {/* <div style={{ display: "flex", justifyContent: "center" }}>
                  <Link aria-label="logo" href="/">
                    <a style={{width:'7.5rem',height:'5rem'}} aria-label="logo" href="/">
                ...
                <div className="social_icon_div">
                  ...
                  >
                    <Image
                      ...
                      // src="https://d239pyg5al708u.cloudfront.net/uploads/banner/fb.png"
                      src={faceb}
            ...
            <div className="columns col-lg-2 col-md-4 col-sm-4 col-12">
              ...
              <div className="list_style">
                <ul>
                  <li onClick={() => this.onClick("https://www.mypustak.com/pages/about-us")}>
                    About Us
                  </li>

                  <li onClick={() => this.onClick("https://www.mypustak.com/pages/about-us/history")}>
                    Our Story
                  </li>

                  <li onClick={() => this.onClick("https://www.mypustak.com/pages/about-us/Impact")}>
                    Our Impact
                  </li>

                  <li
                    onClick={() =>
                      this.onClick("https://www.mypustak.com/pages/about-us/OurCommitment")
                    }
                  >
                    Our Commitment
                  </li>
                  ...
                  <li
                    onClick={() =>
                      this.onClick("https://www.mypustak.com/pages/about-us/free-book-theory")
                    }
                  >
                    Free Book Theory
                  </li>
            ...
            <div className="columns col-lg-2 col-md-4 col-sm-4 col-12">
              ...
              <div className="list_style">
                <ul>
                  <li onClick={() => this.onClick("https://www.mypustak.com/contact-us")}>
                    Contact Us
                  </li>

                  {/* <li onClick={() => this.onClick("https://www.mypustak.com/pages/privacy-policy")}>
                    R-R Policy
                  </li> */}
                  ...
                  <li onClick={() => this.onClick("https://www.mypustak.com/pages/terms-conditions")}>
                    Terms & Conditions
                  </li>
                  <li
                    onClick={() =>
                      this.onClick("https://www.mypustak.com/pages/book-condition-guidelines")
                    }
                  >
                    Book Conditions Guidlines
                  </li>
                  <li onClick={() => this.onClick("https://www.mypustak.com/pages/return-policy")}>
                    Return Policy
                  </li>
                </ul>
              </div>
            ...
            <div className="columns col-lg-2 col-md-4 col-sm-4 col-12">
              ...
              <div className="list_style">
                <ul>
                  <li
                    onClick={() => {
                      window.open("https://partners.mypustak.com/");
                    }}
                  >
                    Join As Seller &nbsp;
                    <b
                    //   className={stylesCat.Newtext}
                      style={{
                        fontSize: "0.6rem",
                        color: "red",
                        position: "absolute",
                  ...
                  <li onClick={() => this.onClick("https://www.mypustak.com/offerpage")}>Offers</li>

                  <li onClick={() => this.onClick("https://www.mypustak.com/proud-donors")}>
                    Proud Donors
                  </li>

                  <li onClick={() => this.onClick("https://www.mypustak.com/donate-books")}>
                    Donate Books
                  </li>
                  <li onClick={() => this.onClick("https://www.mypustak.com/faq")}>
            ...
            {/* ========== */}
            {/* <div className="columns col-lg-2 col-6">
              <div className="heading_div">follow us</div>
              <div className="list_style">
                <ul>
                  <li
                    onClick={() =>
                  ...
                  <li
                    onClick={() =>
                      this.onClick(
                        "https://www.youtube.com/channel/UCgrsyFSctcXUL6hrWrJCawQ"
                      )
                    }
                  >
                    Youtube
          ...
          {/* <div className="pay_method  ">
            <div className="">
              <Image src={cod_img} alt='' />
              <Image src={netBanking_img} alt='' />
              <Image src={mastercard_img} alt='' />
              <Image src={visa_card_img} alt='' />
              <Image src={maestro_img} alt='' />
              <Image src={upi_img} alt='' />
              <Image src={phonepe_img} alt='' />
              <Image src={paytm_img} />
              <Image src={rupay_img} alt='' />
            </div>
          </div> */}
