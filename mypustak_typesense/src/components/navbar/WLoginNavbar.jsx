...
import SearchBox from "./CustomSearchBoxClass2";
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              ...
              <div className="mainNavDiv">
                ...
                {/* for desktop */}
                <MediaQuery minWidth={577}>
                  <div className="midDiv d-sm-flex">
                    {/* <CompleteSearchbox/> */}
                    <InstantSearch
                    ...
                    <CustomSortBy
                      ...
                      items={[
                        {
                          value: `${INSTANTSEARCHSCHEMA}/sort/iDdate:desc`,
                          label: "Newest First",
                        },
                        {
                          value: `${INSTANTSEARCHSCHEMA}/sort/iDdate:asc`,
                          label: "Oldest First",
                        },
                        {
                        ...
                        {
                          value: `${INSTANTSEARCHSCHEMA}/sort/new_pricing:desc`,
                          ...
                          {profileComponents.map((data) => (
                            <React.Fragment key={data.key}>
                              ...
                              >
                                <span
                                  className={
                                    styles.options + " pt-3 pb-2 rounded"
                                  }
                    ...
                    <span
                      ...
                      onClick={(e) => {
                        ...
                        if (props.getuserdetails.email != null) {
                          ...
                          enqueueSnackbar(
                            "Please login to view items in cart",
                            {
                              variant: "warning",
                            }
                          );
                ...
                <MediaQuery maxWidth={576}>
                  ...
                  >
                    ...
                    >
                      ...
                      {/* <SearchBox sdraw={sdraw} delay={350} /> */}
                          ...
                          {Logintoggle ? (
                            <>
                              ...
                              <TextField
                                ...
                                variant="standard"
                                helperText={
                                  EmailErr ? "Enter valid email" : null
                                }
                              />
                              {Logintoggle ? (
                                <span
