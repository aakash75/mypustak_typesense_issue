...
import { getCompExam } from "../../redux/actions/booksActions";
...
class ViewCategory extends Component {
  ...
  clickmenu = ({ as }) => {
    ...
    window.location.replace(Catergory_href, as);
  };
  trackOrder_dialog = () => {
    ...
    return children.map((subOption, index) => {
      ...
      return (
        <div
          ...
          className='col-lg-4'>
          <ListItem button className={classes.maincategory}>
            <ListItemText
              //   inset
                ...
                <div className='sideCategory'>
                  <div className='togglebtn' onClick={this.toggle_cataegory}>
                    <span style={{ marginRight: "5px" }}>
                      <ViewStreamIcon style={{ height: "26px" }} />
                    </span>
                    Select Category
                  </div>
                  <div
