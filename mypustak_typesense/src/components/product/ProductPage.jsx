...
class ProductPage extends Component {
  state = {
    ...
    productData: true,
    SelectCond:
      this.props.bookData.selectedConditon.qty &&
      this.props.bookData.newbook_condition.length > 0
        ? this.props.bookData.SelectCond
        : this.props.bookData.newbook_condition.length > 0
        ? this.props.bookData.newbook_condition
        : this.props.bookData.SelectCond,
    GotoCart: false,
    AlreadyinCartMsg: "",
    notifyopen: false,
    ...
    book_qty_obj: {},
    book_conditions_obj: this.props.bookData.condition_obj,
    selectedConditon: this.props.bookData.selectedConditon,
    defaultImgSrc: this.props.bookData.defaultImgSrc,
    defaultErrImg: "https://mypustak-6.s3.amazonaws.com/books/dumy+book.png",
    ...
    imagesData: [
      {
        id: 1,
        url: `https://mypustak-6.s3.amazonaws.com/books/${this.props.bookData.book.image}`,
      },
      this.props.bookData.book.front_image
        ? {
            id: 2,
            url: `https://d239pyg5al708u.cloudfront.net/uploads/books/medium/front_image/${this.props.bookData.book.front_image}`,
          }
        : null,
      this.props.bookData.book.back_image
        ? {
            id: 3,
            url: `https://d239pyg5al708u.cloudfront.net/uploads/books/medium/back_image/${this.props.bookData.book.back_image}`,
          }
        : null,
    ],
    mainImagSrc: {
  ...
  componentDidMount() {
    ...
    if (this.props.bookData.nodata) {
    } else {
      const productLeftImgThumb = document.querySelector(
        ".product_Left_imgthumb"
      );
      console.log("789654321", productLeftImgThumb);

      const { thumb } = this.props.bookData.book;
      this.setState({
        ErrorOccuredBookImg: false,
        AlreadyinCartMsgNewBook: "",
      });
      const bookConditions = this.props.bookData.bookCondition;
      let old_book_length = Object.getOwnPropertyNames(
        this.props.bookData.bookCondition
      ).length;
      let new_book_length = Object.getOwnPropertyNames(
        this.props.bookData.new_book_data
      ).length;
      console.log(new_book_length, old_book_length, "lengths");
      if (old_book_length == 0 && new_book_length) {
        this.setState({ selectedConditon: this.props.bookData.new_book_data });
      }
      const parent_cate = this.props.bookData.book.category_arr[1];
      const sub_cate = this.props.bookData.book.category_arr[2];
      const sub_urlpath = `/category/${this.props.bookData.book.category_arr[0]}/${parent_cate}/${sub_cate}`;
      const parent_urlpath = `/category/${this.props.bookData.book.category_arr[0]}/${parent_cate}`;
      this.setState({
      ...
      if (this.props.userComponentStatus == 2) {
        ...
        if (user_data && String(user_data.pincode).length == 6) {
          ...
          const wt = this.props.bookData.book.weight;
      ...
      // this.props.check_if_ordered(user_data.id,this.props.bookData.book.book_id).then(res => {
      ...
      // })
      this.props
        .get_book_review_product(this.props.bookData.book.book_id, 0)
        .then((res) => {
      ...
      this.props
        .get_question_product(this.props.bookData.book.book_id, 0, 5)
        .then((res) => {
          this.setState({
      ...
      this.props.list_wishlist.map((data) => {
        if (data.book_id == this.props.bookData.book.book_id) {
          console.log(data.book_id, "858585", this.props.bookData.book.book_id);
          this.setState({
            showWishlist: true,
        ...
        this.props
          ...
          .then((res) => {
            ...
            res.cartData.map((cart) =>
              `${cart.bookInvId}` ===
              `${this.state.selectedConditon.book_inv_id}`
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      prevProps.bookData.bookCondition !== this.props.bookData.bookCondition
    ) {
      const conditionKeys = Object.keys(this.props.bookData.bookCondition);
      if (!conditionKeys.includes("is_soldout")) {
        this.setBookConditionToState(this.props.bookData.bookCondition);
      }
    }
    if (this.props.incart_check !== prevProps.incart_check) {
      if (this.props.incart_check.length) {
        // alert("844" + this.props.incart_check.length)
  ...
  notifyopenModal = (e) => {
    ...
    const passdata = {
      email: email,
      slug: `${this.props.bookData.book.slug}`,
    };
  ...
  changeBookType = (booktype) => {
    this.setState({
      ...
      mainImagSrc:
        booktype == "newbook"
          ? `https://mypustak-6.s3.amazonaws.com/books/${this.props.bookData.new_book_data.image}`
          : `https://mypustak-6.s3.amazonaws.com/books/${this.props.bookData.selectedConditon.image}`,
    });
  };
  ...
  onChangedCondition = (e, change_cond) => {
    if (change_cond.charAt(change_cond.length - 1) == "N") {
      ...
      this.setState({
        ...
        mainImagSrc: {
          url: `https://mypustak-6.s3.amazonaws.com/books/${this.props.bookData.new_book_data.image}`,
        },
      });
    } else {
      this.setState({
    ...
    if (!this.state.ErrorOccuredBookImg) {
      this.setState({
        defaultErrImg: `https://mypustak-6.s3.amazonaws.com/books/${this.props.bookData.book.thumb}`,
      });
    }
  };
  ...
  onOfferChanged = (e, checkvalue) => {
    const { selectedConditon } = this.props.bookData;
    var msgg = "";
  ...
  AddNewBookToCart = (e) => {
    e.preventDefault();
    const { new_book_data } = this.props.bookData;
    console.log(
      new_book_data,
  ...
  DicountedPrice = (price) => {
    let discountedPrice =
      price -
      (price * this.props.bookData.new_book_data.discount_percent) / 100;
  ...
  CashbackPrice = (price) => {
    let cashbackedPrice =
      price -
      (price * this.props.bookData.new_book_data.cashback_percent) / 100;
  ...
  readmorebtn = () => {
    this.setState({ readmore: true, readless: true });
  };
  readlessbtn = () => {
    this.setState({ readless: false, readmore: false });
  };
  ResizeDescription = (bottomDatta) => {
    if (this.state.readmore) {
      ...
      if (bottomDatta) {
        if (bottomDatta.length > 1100) {
          return bottomDatta.substr(0, 1100) + "...";
        } else {
          return bottomDatta;
        }
      }
  ...
  calculateBookDetails = () => {
    const bookdetails = this.props.bookData.book;
    const bookConditionDetails = this.props.bookData.bookCondition;
    const selectedBookCondition = this.state.SelectCond;
    // console.log(this.props.bookData.book, "book");
    ...
    Object.keys(this.props.bookData.bookCondition).map((condition) => {
      let qty = this.props.bookData.bookCondition[condition].total_qty;
  ...
  setBookConditionToState = (bookConditions) => {
    ...
    const bookdetails = this.props.bookData.book;
    let condition_obj = this.props.bookData.condition_obj; //book_inv_id rack_no back_image front_image crop_img
  ...
  updateVeryGoodBookPrice = (book, inventroy, makeAPIReq = true) => {
    // let book = this.props.bookData.book;
  ...
  cartbtn_text = () => {
    ...
    let book_inv_id = selectedBookConditionDetails
      ...
      : this.props.bookData.new_book_data.newbook_inv_id;
  ...
  AddOldBookToCart = (e) => {
    ...
    // alert("2257" + selectedCondition)
    console.log(selectedBookConditionDetails, "selectedBookConditionDetails");
    const book = this.props.bookData.book;
    var msgg = "";
    ...
    let condition_id = selectedBookConditionDetails.book_condition_id
      ? selectedBookConditionDetails.book_condition_id
      : 0;
    this.props.incart_check.map((cart) =>
  ...
  smimgErr = (e) => {
    ...
    e.target.src = "https://mypustak-6.s3.amazonaws.com/books/dumy+book.png";
    return e;
  };
  ...
  submitQuestion = () => {
    if (this.props.userComponentStatus == 2) {
      ...
      let body = {
        book_id: this.props.bookData.book.book_id,
        user_id: this.props.getuserdetails.id,
  ...
  handleImages = () => {
    ...
    if (
      this.props.bookData.new_book_data &&
      this.props.bookData.new_book_data.vendor_image &&
      this.props.bookData.new_book_data.vendor_image.length
    ) {
      this.props.bookData.new_book_data.vendor_image.map((img) => {
        allImages.push(img);
      });
    }
    ...
    this.setState({
      ...
      allImagesForMobileDialog: uniqueUrls,
    });
  ...
  render() {
    const { book, main_Seo_data } = this.props.bookData;
    const {
      book_conditions_obj,
      selectedConditon,
      enteredPincode,
    ...
    const {
      ...
      isbn,
      MRP,
    } = this.props.bookData.response.books_details;
    return this.props.bookData.nodata ? (
      <center>
        <ErrorIcon
      ...
      <React.Fragment>
        {/* <NoSsr><ScrollButton /></NoSsr> */}
        {/*----------------------Product Main Page div------------------------  */}
        <div className={`${styles.main_outterdiv}`}>
          <div
            data-pid={this.props.bookData.book.book_id}
            className={`${styles.product_topdiv}`}
          >
            <div className={`${styles.product_maindiv}`}>
              ...
              >
                <div
                  className={`${
                    this.state.sticky_div == "product_img_sticky"
                  ...
                  <div className={`${styles.left_div_parent}`}>
                    <div className={`${styles.product_Left_innerdiv}  `}>
                      <div className={`${styles.product_Left_imgthumb} col-2 `}>
                        ...
                        {this.props.bookData.new_book_data?.vendor_image?.map(
                          (srcobj, index) => {
                            return (
                              <div
                                key={index}
                              ...
                              >
                                <img
                                  ...
                                  onMouseEnter={() =>
                                    this.setvendorImgsrc(srcobj, index)
                                  }
                                  key={srcobj.id}
                                  className={`${styles.image_thumb} 
                                  }`}
                      ...
                      <div
                        className={` ${styles.product_Left_image_div} row col-10 col-sm-10 col-md-10 col-lg-10  `}
                      >
                        <div
                        ...
                        >
                          <div className=" " style={{}}>
                            ...
                            this.props.bookData.new_book_data.newBookQty >
                              0 ? null : (
                        ...
                        >
                              ...
                              <div className={`${styles.product_assured} `}>
                                {book.is_most_loved ? (
                                  <div
                                    ...
                                    className={styleBookCard.mostLovedDiv}
                                  >
                                    <div
                                      className={styleBookCard.walletOfferDiv}
                                    >
                                      <span className={styleBookCard.Stick2}>
                                        <FavoriteIcon
                          ...
                          <div className={`${styles.icons_div}`}>
                            ...
                            <div>
                              {this.props.bookData.new_book_data.newBookQty >
                                0 || this.state.selectedConditon.qty > 0 ? (
                    ...
                    <div className="left_btn_div ">
                      <MediaQuery minWidth={576}>
                        ...
                        >
                          {this.state.bookType == "newbook" ? (
                            this.props.bookData.new_book_data.newBookQty > 0 ? (
                              <div
                            ...
                            <div className="">
                              ...
                              >
                                Get notified when this book comes back in stock.
                              </div>
                            </div>
                          )}
                        </div>
                ...
                >
                  ...
                  <div className="product_right_title_price ">
                    ...
                    >
                      <h6 className={`${styles.product_title_inner}`}>
                        ...
                        <span
                          itemProp="Book Language"
                          data-info="Book Language and Book paper Type"
                          className={`${styles.languageBindingFont}`}
                        >
                          {" "}
                          ({language},{binding})
                        </span>
                      ...
                      >
                        <span>
                          <h2 className={styles.book_sub_title}>
                            {this.props.bookData.book.author == "NA" ||
                            this.props.bookData.book.author == "" ||
                            this.props.bookData.book.author == " " ||
                            this.props.bookData.book.author == "None" ||
                            this.props.bookData.book.author == null ? null : (
                              <span
                                itemProp={this.props.bookData.book.author}
                                data-info={this.props.bookData.book.author}
                              >
                                By{" "}
                                <Link
                                ...
                                >
                                  {this.props.bookData.book.author.replace(
                                    /(\w)(\w*)/g,
                                    (_, firstChar, rest) =>
                            ...
                            {this.props.bookData.book.publication == "NA" ||
                            this.props.bookData.book.publication == " " ||
                            this.props.bookData.book.publication == null ||
                            this.props.bookData.book.publication ==
                              "None" ? null : (
                              <span
                                itemProp={this.props.bookData.book.publication}
                                data-info={this.props.bookData.book.publication}
                              >
                                By &nbsp;
                                <Link
                                  ...
                                  className="text-primary"
                                >
                                  {this.props.bookData.book.publication.replace(
                                    /(\w)(\w*)/g,
                                    (_, firstChar, rest) =>
                                      firstChar.toUpperCase() +
                                      rest.toLowerCase()
                        ...
                        <div
                          className={`${styles.product_assured} `}
                          style={{}}
                        >
                          <Image
                            alt="use book"
                      ...
                      >
                        <div className={`product_price`}>
                          {this.state.bookType == "newbook" ? (
                            this.state.offertype == "discount" ? (
                              <span
                                itemProp={"price Details"}
                                data-info={"price Details"}
                              >
                                <span
                                  itemProp={"Price"}
                                  data-info={"Price"}
                                ...
                                >
                                  ₹
                                  {this.DicountedPrice(
                                    this.props.bookData.book.MRP
                                  )}
                                </span>{" "}
                                <span
                                  itemProp={"MRP"}
                                  data-info={"MRP"}
                                  className={`${styles.decoration_overline}`}
                                >
                                  ₹{this.props.bookData.book.MRP}
                                </span>{" "}
                                &nbsp;
                                <span
                                  className={`${styles.savedPercent}`}
                                  itemProp={"Discount"}
                                  data-info={"Discount"}
                                >
                                  ₹
                              ...
                              <span>
                                ...
                                >
                                  ...
                                  {this.CashbackPrice(
                                    parseInt(
                                      this.props.bookData.new_book_data.MRP
                                    )
                                  )}
                                  !
                                </span>
                          ...
                          ) : selectedConditon?.book_inv_id
                              ?.toString()
                              ?.includes("IB") ? (
                            <span
                              className={`${styles.payonly}`}
                              itemProp={"price Details"}
                              data-info={"price Details"}
                            >
                              <span
                              ...
                              <span
                                ...
                                className="d-flex "
                              >
                                {this.props.bookData.SelectCond.length ? (
                                  <span
                                    style={{
                                      fontSize: "1.5rem",
                                      fontWeight: "bold",
                            ...
                            >
                              ...
                              <span itemProp={"MRP"} data-info={"MRP"}>
                                {this.props.bookData.SelectCond.length ? (
                  ...
                  this.props.bookData.newbook_condition.length > 0 ? (
                    <div className={`${styles.product_right_condition}`}>
                      ...
                      >
                        <div
                          className={` ${styles.product_book_condition} col-12`}
                                ...
                                {book_conditions_obj.BrandNew ? (
                                  ...
                                  >
                                    <div>
                                      <div>
                                        <span
                                          className="text-dark  d-flex justify-content-evenly "
                                          itemProp={"Brand New Condition"}
                                          data-info={"Brand New Condition"}
                                        >
                                          Brand New{" "}
                                          <Tooltip
                                            title={
                                              this.props.bookData?.book?.book_inv_id
                                                ?.toString()
                                                ?.includes("IB")
                                                ? "Pre-Loved  Book"
                                                : "Book from donors"
                                  ...
                                  >
                                    <div>
                                      <div>
                                        <span
                                          className="text-dark  d-flex justify-content-evenly "
                                          itemProp={"As Good As New Condition"}
                                          data-info={"As Good As New Condition"}
                                        >
                                          <span className={`${styles.font08}`}>
                                            As Good As New
                                          </span>
                                  ...
                                  >
                                    <div>
                                      <div>
                                        ...
                                        <span
                                          className="text-dark  d-flex justify-content-evenly "
                                          itemProp={"Very Good Condition"}
                                          data-info={"Very Good Condition"}
                                        >
                                          Very Good
                                          <Tooltip
                                            title={
                                              book_conditions_obj?.VeryGood?.book_inv_id
                                                ?.toString()
                                                ?.includes("IB")
                                                ? "Pre-Loved  Book"
                                                : "Book from donors"
                                  ...
                                  >
                                    <div>
                                      <div>
                                        ...
                                        <span
                                          className="text-dark  d-flex justify-content-evenly "
                                          itemProp={"Good & Readable Condition"}
                                          data-info={
                                      ...
                                      <div className="subtext_cond">
                                        ...
                                        {this.state.offertype == "discount" ? (
                                          <span
                                            ...
                                            itemProp={"Dicounte Price"}
                                            data-info={"Dicounte Price"}
                                          >
                                            {" "}
                                            ₹
                                            {this.DicountedPrice(
                                          ...
                                          <span
                                            className="font-weight-bold"
                                            itemProp={"Cashback Price"}
                                            data-info={"Cashback Price"}
                                          >
                                            {" "}
                                            ₹
                                            {this.CashbackPrice(
                                  ...
                                  >
                                    <div>
                                      <div>
                                        <span
                                          className="text-dark "
                                          itemProp={"BrandNew Condition"}
                                          data-info={"BrandNew Condition"}
                                        >
                                          BrandNew{" "}
                                        </span>
                                      </div>
                                  ...
                                  >
                                    <div>
                                      <div>
                                        <span
                                          className="text-dark "
                                          itemProp={"As Good As New Price"}
                                          data-info={"As Good As New Price"}
                                        >
                                          As Good As New
                                        </span>
                                      </div>
                                  ...
                                  >
                                    <div>
                                      <div>
                                        ...
                                        <span
                                          className="text-dark "
                                          itemProp={"Very Good Price"}
                                          data-info={"Very Good Price"}
                                        >
                                          Very Good
                                        </span>
                                      </div>
                  ...
                  {this.state.bookType == "newbook" ? (
                    <div className={`${styles.product_right_condition}`}>
                      ...
                      >
                        ...
                        <div
                          className={`${styles.offer_choose_div}  col-lg-8 col-sm-8`}
                        >
                          <div className={`${styles.Selection_book_cond}`}>
                            <div
                              className={`${styles.book_condition_button} d-flex`}
                            >
                              {this.props.bookData.book.discount_percent ? (
                                <button
                                  className={
                                    this.state.offertype === "discount"
                              ...
                              {this.props.bookData.book.cashback_percent ? (
                                <button
                                  className={
                  ...
                  {this.state.bookType == "newbook" ? (
                      ...
                      <div className="product_right_price_details border  mt-1">
                        ...
                        >
                          <div className="row  m-2">
                            ...
                            <div className="col-6">
                              ₹ <s>{this.props.bookData.book.MRP}</s>
                              {this.state.offertype == "discount" ? (
                          ...
                          <div className="row  m-2">
                            <div className={` ${styles.handeling_mrp} col-6`}>
                              <span
                                itemProp={"delivery charge"}
                                data-info={"delivery charge"}
                              >
                                Delivery charge
                              </span>
                            </div>
                            <div className="col-6">
                              {this.props.bookData.new_book_data.shipping ? (
                                <span
                                // className={` ${styles.handeling_mrp}`}
                                // style={{ color: "black" }}
                                >
                                  {" "}
                                  ₹{this.props.bookData.new_book_data.shipping}
                                ...
                                <span
                                  className={` ${styles.handeling_mrp} text-success `}
                          ...
                          <div className="row  m-2">
                            <div className={` ${styles.handeling_mrp} col-6`}>
                              <span
                                itemProp={"Total amount"}
                                data-info={"Total amount"}
                              >
                                Total Amount
                              </span>
                            </div>
                        ...
                        <h3 className="text-center   p-3">
                          ...
                          &nbsp;
                          <span
                            className={`${styles.product_price_des}`}
                            itemProp={"Safe And Secure Payment"}
                            data-info={"Safe And Secure Payment"}
                          >
                    ...
                    <div className="product_right_price_details  mt-1 border">
                      <div className={`${styles.product_price_details_inner}`}>
                        {this.props.bookData.book?.book_inv_id
                          ...
                          <div className="row  m-2">
                            ...
                            <div className="col-6">
                              ...
                              <span className="text-success font-weight-bold">
                                &nbsp;₹{parseInt(selectedConditon.shipping)}
                              </span>
                            </div>
                          </div>
                        ) : (
                        ...
                        <h3 className="text-center p-3">
                          <span itemProp={"Verified"} data-info={"Verified"}>
                            <VerifiedUserIcon className="text-success" />
                          </span>
                          &nbsp;
                          <span
                        ...
                        >
                          <div className={`${styles.delivery_div} `}>
                            <div className={`${styles.delevery_title} `}>
                              <span
                                itemProp={"Estimated Delivery"}
                                data-info={"Estimated Delivery"}
                              >
                                Estimated Delivery
                              </span>
                            </div>
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  this.ApiEstimate_delivery(
                                    enteredPincode,
                                    this.props.bookData.book.weight
                                  );
                                }}
                              >
                                Check
                          ...
                          <div style={{ padding: "5px", paddingTop: "0" }}>
                            ...
                            <h3 className={`${styles.delevery_title} `}>
                              <span
                                style={{
                                  fontSize: "0.85rem",
                                  cursor: "pointer",
                                }}
                                itemProp={"Return Policy"}
                                data-info={"Return Policy"}
                                onClick={this.handleRefundPolicy}
                              >
                          ...
                          {binding ? (
                            <div className="col-md-6 px-2 py-1 ">
                              <div className="row ">
                                ...
                                <span
                                  className="col-6 "
                                  itemProp={selectedConditon.binding}
                                  data-info={"selectedConditon.binding"}
                                >
                          ...
                          {publication_date ? (
                            <div className="col-md-6 px-2 py-1 ">
                              <div className="row">
                                <span
                                  className="col-6 "
                                  itemProp={"Publication Date"}
                                  data-info={"Publication Date"}
                                >
                                  Publication Date :{" "}
                                </span>
                                <span
                                  className="col-6 "
                                  itemProp={selectedConditon.publication_date}
                                  data-info={selectedConditon.publication_date}
                                >
                          ...
                          {isbn ? (
                            <div className="col-md-6 px-2 py-1">
                              <div className="row ">
                                ...
                                <span
                                  className="col-6  "
                                  itemProp={selectedConditon.isbn}
                                  data-info={selectedConditon.isbn}
                                >
                          ...
                          {language ? (
                            <div className="col-md-6 px-2 py-1 ">
                              <div className="row">
                                ...
                                <span
                                  className="col-6 "
                                  itemProp={selectedConditon.language}
                                  data-info={selectedConditon.language}
                                >
                          ...
                          {rack_no && this.state.selectedConditon.qty > 0 ? (
                            <div className="col-md-6 px-2 py-1 ">
                              <div className="row ">
                                ...
                                <span
                                  className="col-6 "
                                  itemProp={selectedConditon.rack_no}
                                  data-info={selectedConditon.rack_no}
                                >
                          ...
                          {no_of_pages ? (
                            <div className="col-md-6 px-2 py-1 ">
                              <div className="row">
                                ...
                                <span
                                  className="col-6 "
                                  itemProp={selectedConditon.no_of_pages}
                                  data-info={selectedConditon.no_of_pages}
                                >
                          ...
                          {publication ? (
                            <div className="col-md-6 px-2 py-1 ">
                              <div className="row">
                                ...
                                <span
                                  className="col-6 "
                                  itemProp={selectedConditon.publication}
                                  data-info={selectedConditon.publication}
                                >
                                  {selectedConditon.publication}
                                </span>
                              </div>
                      ...
                      <div>
                        {selectedConditon.book_desc?.length ? (
                          <>
                            ...
                            <div>
                              {selectedConditon.book_desc.length > 1100 ? (
                                <p
                              ...
                              {selectedConditon.book_desc.length > 1200 ? (
                                <p
                                  ...
                                  onClick={this.readlessbtn}
                                >
                                  {!this.state.readless ? `` : `Read Less`}
                                </p>
                              ) : null}
                            </div>
                          </>
                  ...
                  <div className={`mt-2`}>
                    <div className={`${styles.book_review_div}`}>
                      <div className={`${styles.book_review_heading} p-2 `}>
                        ...
                        <Button
                          ...
                          onClick={() => {
                            if (this.props.userComponentStatus == 2) {
                              window.location.assign(
                                `/write-review?${this.props.bookData.book.book_id}`
                              );
                            } else {
                              let BackUrl = `write-review?${this.props.bookData.book.book_id}`;
                              // localStorage.setItem('BackUrl', BackUrl);
                              window.location.replace(
                                `/account/Loginpage?ret=/${BackUrl}`
                              );
                            }
                          }}
                          style={{ textTransform: "capitalize" }}
                      ...
                      {Object.keys(this.state.review_counts).length == 0 ||
                      this.state.review_counts.total_count == 0 ? null : (
                        <div className="p-2">
                          <RatingGraph
                            ...
                            total_reviews={
                              this.state.review_counts.total_review_count
                            }
                          />
                      ...
                      {this.state.review_data.length > 3 ? (
                        <div
                          ...
                          onClick={() => {
                            window.location.assign(
                              `/product/ReviewAll?${this.props.bookData.book.book_id}`
                            );
                            // window.open(`/product/ReviewAll?${this.props.bookData.book.book_id}`)
                          }}
                        >
                          <h5
                            style={{ fontSize: "1rem", margin: 0, padding: 0 }}
                          >
                            View All Review ({this.state.review_data.length - 3}
                            )
                          </h5>
                          <h5>
                            <ArrowForwardIosIcon
                  ...
                  <div className="mt-2">
                    <div className={`${styles.book_review_div}`}>
                      {this.state.question_loader ? null : this.state
                          .question_data_counts == 0 ? (
                          ...
                          <Button
                            ...
                            onClick={() => {
                              if (this.props.userComponentStatus == 2) {
                                ...
                                let BackUrl = `product/${this.props.bookData.book.slug}?${this.props.bookData.book.book_id}`;
                                // localStorage.setItem('BackUrl', BackUrl);
                                window.location.replace(
                                  `/account/Loginpage?ret=/${BackUrl}`
                                );
                        ...
                        <div>
                          ...
                          {this.state.question_data_counts > 5 ? (
                            <div
                              onClick={() => {
                                window.location.assign(
                                  `/question-answer?${this.props.bookData.book.book_id}`
                                );
                              }}
                              className="p-2"
                              style={{
                            ...
                            >
                              View {this.state.question_data_counts} Questions{" "}
                              <ArrowForwardIcon
                                style={{ fontSize: "0.9rem" }}
                              />
                            </div>
          ...
          <div style={{ marginTop: "1rem" }}>
            {/* <BookSugesstionUnbxdbyFilter
              value={[this.props.bookData.book.category]}
              title='Similar Books'
              attribute={"category"}
              redirection={
                this.props.bookData.book.category_arr.length == 3
                  ? "/category/" +
                  this.props.bookData.book.category_arr[0] +
                  "/" +
                  this.props.bookData.book.category_arr[1] +
                  "/" +
                  this.props.bookData.book.category_arr[2] +
                  ...
                  : this.props.bookData.book.category_arr.length == 2
                    ? "/category/" +
                    this.props.bookData.book.category_arr[0] +
                    "/" +
                    this.props.bookData.book.category_arr[1] +
                    "?&sortBy=mp_books_v3/sort/num_is_out_of_stack:asc,i_date:desc&author=&publication=&binding=&language=&book_condition=&aged_group="
                    : this.props.bookData.book.category_arr.length == 1
                      ? "/category/" +
                      this.props.bookData.book.category_arr[0] +
                      "?&sortBy=mp_books_v3/sort/num_is_out_of_stack:asc,i_date:desc&author=&publication=&binding=&language=&book_condition=&aged_group="
                      : null
          ...
          <div style={{ marginTop: "1rem" }}>
            {/* <BookSugesstionUnbxdbyFilter
              value={[this.props.bookData.book.author]}
              title='Similar Author'
              attribute={"author"}
              redirection={
                this.props.bookData.book.author
                  ? "/author/books-" +
                  this.props.bookData.book.author.split(" ").join("-") +
                  "?&sortBy=mp_books_v3/sort/num_is_out_of_stack:asc,i_date:desc&author=&publication=&binding=&language=&book_condition=&aged_group="
                  : null
              }
            /> */}
          ...
          <div style={{ marginTop: "1rem" }}>
            {/* <BookSugesstionUnbxdbyFilter
              value={[this.props.bookData.book.publication]}
              title='Similar Publication'
              attribute={"publication"}
              redirection={
                this.props.bookData.book.publication
                  ? "/publication/books-" +
                  this.props.bookData.book.publication.split(" ").join("-") +
                  "?&sortBy=mp_books_v3/sort/num_is_out_of_stack:asc,i_date:desc&author=&publication=&binding=&language=&book_condition=&aged_group="
                  : null
              }
            /> */}
          ...
          <DialogContent style={{ padding: 0 }}>
            {this.state.questionSuccess ? (
              ...
              >
                ...
                >
                  <span>We will notify you when it gets answered</span>
                  <Button
                    onClick={() => {
                      this.setState({
                        openQuestionDialog: false,
              ...
              <div className={`${styles.questionDialogMainDiv}`}>
                <div className={`${styles.questionDialogLeftDiv}`}>
                  <ul style={{ fontSize: "0.95rem" }}>
                    ...
                    <li style={{ marginBottom: "1rem" }}>
                      Reach out to MyPustak customer care for queries related to
                ...
                <div className={`${styles.questionDialogRightDiv}`}>
                  ...
                  >
                    <Button
                      disabled={
                        this.state.inputQuestion.length < 5 ||
        ...
        >
          ...
          <DialogContent style={{ minWidth: "50vw" }}>
            {this.state.multiplebook_loader ? (
              <div>
                <center>
                  <CircularProgress />{" "}
                </center>
              ...
              <div>
                {this.state.available_books.map((avaible_book, index) => (
                  <div className=" d-flex border m-1 p-2" key={index}>
                    <img
                      style={{ width: "4rem", height: "5rem" }}
                      src={`https://mypustak-6.s3.amazonaws.com/books/${avaible_book.image}`}
                      id="cartbookimg"
                      title={
                        main_Seo_data.title_tag
                          ? main_Seo_data.title_tag
                    ...
                    >
                      <div>
                        <h1>{avaible_book.title}</h1>
                      </div>
                      <div>
                        <div>
                          <h2>
                            By {avaible_book.author}&nbsp; (Author) | By{" "}
                            {avaible_book.publication}&nbsp; (Publication)
                          </h2>
                        </div>
                        <div>
                          <h2>
                            Shipping & Handling charges :{" "}
                            {avaible_book.shipping}
                          </h2>
                        </div>
                        <div>
                          <h2>
                    ...
                    <div>
                      <Button
                        ...
                        style={{
                          ...
                          outline: "none",
                          textTransform: "capitalize",
                          background: this.check_book_incart(
                            avaible_book.book_inv_id
                          )
                        ...
                        disabled={
                          avaible_book.book_inv_id ==
                          this.state.multiple_add_loader
                            ? true
                            : false
                        }
                      >
                        ...
                        this.state.multiple_add_loader ? (
                          ...
                          this.multiplecartbtn_text(avaible_book.book_inv_id)
                        )}
                      </Button>
                    </div>
                    <hr />
        ...
        {/* mobile size image details dialog */}
        <MediaQuery maxWidth={576}>
          <Dialog
            // fullScreen={window.screen.width < 500 ? true : false}
            fullScreen={true}
        ...
        <MediaQuery minWidth={577}>
          ...
          >
            ...
            {/* <Toolbar style={{ position: "absolute", top: "0", cursor: "pointer", right: "0" }} onClick={() => { this.closeImageDialog() }} >
            <IconButton
              edge="start"
              color="inherit"
              ...
              aria-label="close"
            >
              <CloseIcon style={{ cursor: "not-allowed", border: "1px solid red" }} onClick={() => { this.closeImageDialog() }} />
            </IconButton>
