...
import bannerImage from "../../assets/2banner.jpeg";
          ...
          <div style={{ display: "flex", position: "relative" }}>
            {props.banners.data.map((banner, index) => {
              return banner.banner_position == 2 ? (
                <>
                  <div
                    className={`px-2 my-2 rounded-md ${styles.display_575}`}
                    style={{
                      borderRadius: "5px",
                      width: `${100 / display_item}vw`,
                      height: height,
                    }}
                  >
                    <Image
                  ...
                  <div
                    className={`px-2 my-2 rounded-md ${styles.display_576}`}
                    style={{
                      borderRadius: "5px",
                      width: `${100 / mob_display_item}vw`,
                      height: height,
                    }}
                  >
                    <Image
                  ...
                  <div
                    className={`px-2 my-2 rounded-md ${styles.display_768}`}
                    style={{
                      borderRadius: "5px",
                      width: `${100 / display_item}vw`,
                      height: height,
                  ...
                  >
                    <Image
                      ...
                      // src={`https://d239pyg5al708u.cloudfront.net/uploads/homebanner/${banner.banner_image}`}
                      //  src="https://d34a0mln2492j4.cloudfront.net/unsigned/resize:fit:820:460:0/gravity:sm/plain/https%3A%2F%2Fs3-ap-south-1.amazonaws.com%2Fbookscape-s3-bucket%2F35D39D8BFC1-trendingtiles.jpg"
                      src={bannerImage}
                      className="rounded-md"
                      sizes="100vw"
                      style={{
                  ...
                  <div
                    className={`px-2 my-2 rounded-md ${styles.display_576_767}`}
                    style={{
                      borderRadius: "5px",
                      width: `${100 / display_item}vw`,
                      height: height,
                  ...
                  <div
                    className={`px-2 my-2 rounded-md ${styles.display_992}`}
                    style={{
                      borderRadius: "5px",
                      width: `${100 / display_item}vw`,
                      height: height,
