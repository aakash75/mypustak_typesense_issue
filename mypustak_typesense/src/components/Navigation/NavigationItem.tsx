  ...
  const renderMainItem = (item: NavItemType) => {
    ...
    return (
      <div className={`h-20 flex-shrink-0 flex items-center  `}>
        <Link
          className={`inline-flex items-center text-sm lg:text-[15px] ${item?.name === "Blogs" && "bg-slate-400 " } font-medium text-slate-700 dark:text-slate-300 py-2.5 px-4 xl:px-5 rounded-full hover:text-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 dark:hover:text-slate-200`}
          href={item?.href}
