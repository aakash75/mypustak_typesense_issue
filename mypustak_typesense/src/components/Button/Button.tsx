...
const Button: FC<ButtonProps> = ({
  ...
  switch (pattern) {
    ...
    case "third":
      colors =
        "bg-white  text-black-500 dark:bg-neutral-900 ring-1 ring-neutral-300 hover:ring-neutral-400 dark:ring-neutral-700 dark:hover:ring-neutral-500";
      break;
  ...
  if (!!href) {
    return (
      <Link href={href} className={`${CLASSES} `} onClick={handleSubmit} type={type}>
        {loading && <Loading />}
  ...
  return (
    <button
      ...
      className={`${CLASSES} bg-blue-600 text-white`}
