...
import styleBookCard from "../../styles/Recomended.module.css";
...
function RecommendBook_old(props) {
  ...
  const handleClose = () => {
    // props.show_books_in_popup(MyCart)
    setopen(false);
    ...
    <div data-pid={props.book.book_id}>
      <div className={`${styleBookCard.mainBookDiv}`}>
        ...
        >
            ...
            >
              ...
              >
                <Image
                  ...
                  onClick={() => {
                    // window.location.assign(props.book.productUrl)
                    let slug = props.book.title.split(" ").join("-");
                    const url = `${slug}-${
                  ...
                  src={
                    onerror
                      ...
                      : props.book.imageUrl[0]
                  }
                  // sizes="100vw"
                  // sizes="(max-width: 768px) 100vw, (max-width: 1200px) 150vw, 100vw"
                  sizes="(max-width: 480px) 50vw, (max-width: 768px) 50vw, (max-width: 1024px) 50vw, (max-width: 1200px) 150vw, 100vw"
                  style={{
                    width: "100%",
                    height: "auto",
                  }}
          ...
          <div className={`${styleBookCard.textDiv}`}>
                ...
                <center>
                  <Button
                    ...
                    style={{
                      ...
                      background: incart.includes(parseInt(props.book.bookId))
                    ...
                    className={`button ${
                      incart.includes(parseInt(props.book.bookId))
                        ? "alreadyAddedToCart"
                        : ""
                    }`}
                    onClick={
        ...
        {`
          * {
          ...
          .button {
            ...
            font-size: 0.75rem;
            // line-height: 14px;
            background:linear-gradient(90deg, #ff6600 0%, #e05a00 100%);
          }
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    show_books_in_popup: (MyCart) => dispatch(show_books_in_popup(MyCart)),
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(RecommendBook_old);
