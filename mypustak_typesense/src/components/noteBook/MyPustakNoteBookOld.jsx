...
import RatingGraph from "../userReview/RatingGraph";
...
import Fullfilled_strip from '../Fullfilled_strip';
import moment from 'moment';
import { get_book_review_product, get_question_product, save_question } from '../../redux/actions/productAction';
import NoteBookDesc from './NoteBookDesc';
import Link from 'next/link';
import Popup from 'reactjs-popup';
import ReturnPolicyDialog from "../return_policy/ReturnPolicyDialog";
...
class MyPustakNoteBook extends Component {
    ...
    state = {
        ...
        quantity_to_add: this.props.note_book_details.default_selected_qty,
        onerror: false,
        Add_cartLoader: false,
        discount_percent: this.props.discount_percent,
        ImagSrc: this.props.note_book_details.images[0],
        review_order_id: "",
        review_data: [],
        review_counts: {},
        enteredPincode: "",
    ...
    async componentDidMount() {
        ...
        console.log(Object.keys(Router.query)[0], "query");
        ...
        if (this.props.userComponentStatus == 2) {
            ...
            this.props.get_book_review_product(book_id, 0).then(res => {
            ...
            this.props.get_question_product(book_id, 0, 5).then(res => {
                this.setState({
            ...
            if (user_data && String(user_data.pincode).length == 6) {
                ...
                const wt = Number(this.props.note_book_details.wt) * Number(this.state.quantity_to_add)
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (this.state.quantity_to_add != prevState.quantity_to_add) {
            this.props.note_book_details.qty_discount.map(discount => {
    ...
    add_notebook_to_cart = () => {
        ...
        const { getuserdetails, note_book_details } = this.props;
    ...
    calculate_withoutgst = (gst_per) => {
        ...
        let total_value = this.DicountedPrice(this.props.note_book_details.mrp * this.state.quantity_to_add)
    ...
    submitQuestion = () => {
        if (this.props.userComponentStatus == 2) {
            ...
            let body = {
                book_id: this.props.note_book_details.product_code,
                ...
                <div className={`${styles.main_outterdiv}`}>
                                    ...
                                    <div className={`${styles.left_div_parent}`}>
                                        <div className={`${styles.product_Left_innerdiv}`}>
                                            <div className={`${styles.product_Left_imgthumb} col-2`}>
                                                {this.props.note_book_details.images.map((srcobj, index) => {
                                                    return (
                                                        <div
                                                            key={index}
                                    ...
                                    <div className='product_right_title_price '>
                                        <div className={`${styles.product_right_title_price_inner} pb-3 pt-2 mb-3`}>
                                            ...
                                            <h6 className={`${styles.product_title_inner}`}>
                                                {this.props.note_book_details.title}
                                            </h6>
                                            <div className={`${styles.product_title_price} mt-2 d-flex justify-content-start  align-items-center`}>
                                                <div className={`product_price`}>
                                                    <span className={`${styles.font15}`}>
                                                        ...
                                                        <span>{" "}₹{this.calculate_withoutgst(this.props.note_book_details.gst_percent)}</span>
                                                    ...
                                                    <span>
                                                        ( ₹{this.DicountedPrice(this.props.note_book_details.mrp * this.state.quantity_to_add)}<span> incl. GST</span> )
                                                    ...
                                                    <span className={`${styles.savedPercent} text-success`}>
                                                        ₹
                                                        {Math.ceil(
                                                            this.props.note_book_details.mrp * (this.state.discount_percent / 100) * this.state.quantity_to_add
                                                        )}{" "}
                                                ...
                                                <table>
                                                    ...
                                                    >
                                                        ...
                                                        <div style={{ display: "flex", alignItems: "center", whiteSpace: "nowrap" }}>
                                                            {
                                                                this.props.quantity_arr.map((q, index) => {
                                                                    return (
                                                                        <span
                                                                            key={index}
                                                                            onClick={() => {
                                                                            ...
                                                                            style={{
                                                                                background: this.state.quantity_to_add >= this.props.quantity_arr[5] && index == 5 ? "linear-gradient(90deg, #2157ad 0%, #6190da 100%)" : q == this.state.quantity_to_add ? "linear-gradient(90deg, #2157ad 0%, #6190da 100%)" : "#d7e2ff", color: this.state.quantity_to_add >= this.props.quantity_arr[5] && index == 5 ? "#d7e2ff" : q == this.state.quantity_to_add ? "#d7e2ff" : "gray",
                                            ...
                                            {this.props.note_book_details.instock_qty > 0 ?
                                                        ...
                                                        <div className={`${styles.product_price_details_inner} col-md-8`}>
                                                            <div className='d-flex m-2'>
                                                                ...
                                                                <div className={` ${styles.handeling_mrp_value}`}>
                                                                    ...
                                                                    <s style={{ color: "#484848", size: "1rem" }}> ₹ {this.props.note_book_details.mrp * this.state.quantity_to_add}</s>
                                                            ...
                                                            <div className='d-flex m-2'>
                                                                ...
                                                                <div className='' style={{ fontSize: "1.2rem", color: '#ff5e1f' }}>
                                                                    <div>
                                                                        <span>{" "}₹ {this.calculate_withoutgst(this.props.note_book_details.gst_percent)}</span> <span> excl. GST</span>
                                                                    </div>
                                                                    ...
                                                                    <Button
                                                                        ...
                                                                        onClick={() => {
                                                                            this.ApiEstimate_delivery(
                                                                                enteredPincode,
                                                                                Number(this.state.quantity_to_add) * Number(this.props.note_book_details.wt), true
                                                                            );
                                                                        }}>
                                                                        Check
                                                                    </Button>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className='row m-2' style={{}}>
                                                            <div className='col-md-5 px-2 py-1 '>
                                                                {this.props.note_book_details.features.slice(0, this.props.note_book_details.features.length / 2).map((feature, index) => {
                                                                    return (
                                                            ...
                                                            <div className='col-md-6 px-2 py-1'>
                                                                {this.props.note_book_details.features.slice(this.props.note_book_details.features.length / 2).map((feature, index) => {
                                                                    return (
                                                                        <div className="d-flex" key={index}>
                                                                            <div className={styles.details} style={{ textTransform: 'capitalize', minWidth: "8rem", textAlign: 'right' }}>{feature.feature_title} : &nbsp;</div>
                                                                            <div className={styles.details} style={{ textTransform: 'capitalize' }}>
                                                        ...
                                                        <div>
                                                            {this.props.note_book_details.description?.length ? (
                                                                <>
                                                                    {this.props.note_book_details.description.length > 2 ? (
                                                                        <h5 className='mx-3'>Description</h5>
                                                                    ) : null}
                                                                    <div className='m-3'>
                                                                        <NoteBookDesc description={this.props.note_book_details.description} />
                                                ...
                                                <div className={`${styles.book_review_div}`}>
                                                    <div className={`${styles.book_review_heading}  p-2`}>
                                                        ...
                                                        <Button variant="outlined"
                                                            onClick={() => {
                                                                if (this.props.userComponentStatus == 2) {
                                                                    Router.push(`/write-review?${this.props.note_book_details.product_code}`);
                                                                }
                                                                else {
                                                                    let BackUrl = `write-review?${this.props.note_book_details.product_code}`;
                                                    ...
                                                    {this.state.review_data.length > 3 ?
                                                        <div
                                                            ...
                                                            onClick={() => {
                                                                Router.push(`/mypustak-notebook/ReviewAll?${this.props.note_book_details.product_code}`)
                                                            }} >
                                                        ...
                                                        this.state.question_data_counts == 0 ?
                                                                ...
                                                                <Button variant="outlined"
                                                                    onClick={() => {
                                                                        if (this.props.userComponentStatus == 2) {
                                                                            ...
                                                                            let BackUrl = `mypustak-notebook?${this.props.note_book_details.product_code}`;
                                                                            window.location.replace(`/account/Loginpage?ret=/${BackUrl}`);
                                                            ...
                                                            <div>
                                                                ...
                                                                {this.state.question_data_counts > 5 ?
                                                                    <div onClick={() => {
                                                                        Router.push(`/question-answer?${this.props.note_book_details.product_code}`);
                    ...
                    <Dialog
                        ...
                        <DialogTitle>
                            ...
                            <IconButton
                                onClick={() => {
                                    this.setState({ BulkOrderDialog: false, quantity_to_add: this.props.quantity_arr[5] });
                                }}
                            ...
                            <div className={styles.bulkMainDiv}>
                                <div className={styles.bulkDiv}>
                                    ...
                                    <div className={styles.bulkArrowDiv}>
                                        ...
                                        <IconButton
                                            disabled={this.state.quantity_to_add == this.props.quantity_arr[5] ? true : false}
                                            onClick={() => {
                                                this.setState({
                                                    quantity_to_add: this.state.quantity_to_add - this.props.note_book_details.qty_group_by
                                                })
                                ...
                                <div style={{ flex: 10 }}>
                                    <span style={{ fontSize: "0.8rem" }}>
                                        <InfoIcon color='#fff' /> Multiples of {this.props.note_book_details.qty_group_by}
                                    </span>
                                </div>
