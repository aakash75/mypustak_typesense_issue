export async function generateMetadata({ params, searchParams }, parent) {
  const body = {
    url: "https://www.mypustak.com/search",
  };
  ...
  if (seo_data.title_tag) {
    ...
    meta_description =
      "Only online free books used bookstore . Delivering in all pincodes in India. Providing fast delivery. 100% Quality assured. Engineering, medical, government jobs, novels, olympiad, school, children, university and many more books available.";
  }
