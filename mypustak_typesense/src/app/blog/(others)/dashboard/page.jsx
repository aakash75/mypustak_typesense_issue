...
const DashboardSubmitPost = (props) => {
  const Router = useRouter()
      ...
      //  console.log(props.userComponentStatus,"2355")
  ...
  return (
    <div className="rounded-xl md:border md:border-neutral-100 dark:border-neutral-800 md:p-6">
      ...
      <Link href="/blog/dashboard/submit-post" >
...
export default connect(mapStateToProps, mapDispatchToProps)(DashboardSubmitPost);
