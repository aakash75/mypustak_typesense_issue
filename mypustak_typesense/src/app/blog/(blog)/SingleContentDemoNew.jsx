...
// import { getPostBySlug, getUserPostBySlug } from "@/Redux/Features/User/getUserPostBySlugSlice";
import { connect } from "react-redux";
const SingleContentDemoNew = (props) => {

    // const blogState = useSelector(getPostBySlug);
  ...
  console.log(props?.postBySlug,"postBySlug");
    const htmlContent = props?.postBySlug?.data?.article_content;
